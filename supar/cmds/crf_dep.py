...
def main():
    ...
    subparser.add_argument('--train', default='data/ptb/train.gold.conllu', help='path to train file')
    subparser.add_argument('--unsup', help='path to unsupervised file')
    subparser.add_argument('--dev', default='data/ptb/dev.gold.conllu', help='path to dev file')
    subparser.add_argument('--test', default='data/ptb/test.gold.conllu', help='path to test file')
    ...
    subparser.add_argument('--data', default='data/ptb/test.gold.conllu', help='path to dataset')
    # predict
